...
class ViewExport: UITableViewController, UIDocumentInteractionControllerDelegate {
    ...
    func exportSimpleXML() {
        ...
        let base64String = imageData!.base64EncodedString(.encoding76CharacterLineLength)
        ...
        let _ = xmlSimpleXML["XiaiPad"].addChild(name: "image", value: trimmedBase64String, attributes: nil)
    ...
    func exportSVG() {
       // encode image to base64
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:format", value: "image/svg+xml", attributes: nil)
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:title", value: getElementValue("title"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:date", value: getElementValue("date"), attributes: nil)
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"]["dc:creator"]["cc:Agent"].addChild(name: "dc:title", value: getElementValue("creator"), attributes: nil)
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"]["dc:rights"]["cc:Agent"].addChild(name: "dc:title", value: getElementValue("rights"), attributes: nil)
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"]["dc:publisher"]["cc:Agent"].addChild(name: "dc:title", value: getElementValue("publisher"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:identifier", value: getElementValue("identifier"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:source", value: getElementValue("source"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:relation", value: getElementValue("relation"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:language", value: getElementValue("language"), attributes: nil)
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"]["dc:subject"]["rdf:Bag"].addChild(name: "rdf:li", value: getElementValue("keywords"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:coverage", value: getElementValue("coverage"), attributes: nil)
        
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"].addChild(name: "dc:description", value: getElementValue("description"), attributes: nil)
        ...
        let _ = xmlSVG["svg"]["metadata"]["rdf:RDF"]["cc:Work"]["dc:contributor"]["cc:Agent"].addChild(name: "dc:title", value: getElementValue("contributor"), attributes: nil)
        ...
        if let xmlDetails = xml.root["details"]["detail"].all {
            for detail in xmlDetails {
                ...
                let _ = currentDetail.addChild(name: detailType, value: "", attributes: detailAttributes)
